    ...
    public partial class Form1 : Form
    {
       ...
       // string _updatepath = @"C:\Users\Admin\Downloads\621c684c0d849b34c4a08a28.json";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (objAssessmentData.sections[SectionList].items.Count - 1 >= ItemList)
            {
            ...
            for (int j = 11; j <= (objAssessmentData.sections[SectionList].items.Count + objAssessmentData.sections[0].items.Count); j++)
                {
                    UserControl1 us = new UserControl1(j);
                    ...
                    UserControl3 us3 = new UserControl3(j);
                    if (objAssessmentData.sections[SectionList].items.Count + 1 == j)
                    {
                        us3.issectionindicated = true;
                    }
                    else
